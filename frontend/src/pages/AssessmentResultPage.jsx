...
export default function AssessmentResultPage() {
  ...
  const ScoreCard = ({ title, score, description }) => {
    ...
    return (
      <div className="rounded-xl p-6 border" style={{ background: CREAM, borderColor: SOFT_BLUE }}>
        <div className="flex justify-between items-start mb-3">
          <h3 className="text-base font-semibold" style={{ color: NAVY }}>{title}</h3>
          <span className="text-2xl font-bold" style={{ color: NAVY }}>{numScore.toFixed(1)}</span>
        </div>
        <p className="text-sm mb-4" style={{ color: '#4A6080' }}>{description}</p>
        <div className="w-full rounded-full h-3" style={{ background: SOFT_BLUE }}>
          <div
  ...
  return (
    <div className="min-h-screen py-12 px-6" style={{ background: CREAM }}>
      <div className="w-full max-w-4xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-2" style={{ color: NAVY }}>Restart</h1>
          <p style={{ color: '#4A6080' }}>Hasil Penilaian Karir Anda</p>
        </div>
        ...
        {result && (() => {
          ...
          return (
            <>
              {/* Score Summary */}
              <div className="rounded-2xl shadow-lg p-8 border mb-8" style={{ background: '#fff', borderColor: SOFT_BLUE }}>
                <h2 className="text-2xl font-bold mb-6" style={{ color: NAVY }}>Ringkasan Skor</h2>
              ...
              <div className="rounded-2xl shadow-lg p-8 border mb-8" style={{ background: '#fff', borderColor: SOFT_BLUE }}>
                ...
                <p className="text-sm mb-6" style={{ color: '#4A6080' }}>
                  Berdasarkan hasil penilaian, profesi berikut paling sesuai dengan profil kemampuan dan kepribadian Anda:
                </p>
